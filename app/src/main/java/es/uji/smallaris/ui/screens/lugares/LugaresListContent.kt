            ...
            Box(
                ...
                if (items.isEmpty()) {
                    ...
                    LazyListLugarInteres(
                        ...
                        checkSelected = { other: LugarInteres -> lugarInteresSelected == other },
...
fun LugarInteresListable(
    ...
    ObjetoListable(
        ...
        terciaryInfo = "N ${lugarInteres.latitud.toCleanString(5)}\nW ${
            lugarInteres.longitud.toCleanString(
                5
            )
        }",
...
val lugarInteresTestData = listOf(
    ...
    LugarInteres(
        42.8584,
        -2.6819,
        "San Juan de Gaztelugatxe, Bermeo, País Vasco, España",
        "Bermeo"
    ),
    LugarInteres(
        38.3452,
        -0.4811,
        "Castillo de Santa Bárbara, Alicante, Comunidad Valenciana, España",
        "Alicante"
    ),
