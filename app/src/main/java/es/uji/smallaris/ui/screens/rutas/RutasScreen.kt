        ...
        when (currentContent.value) {
            RutaScreenContent.Lista ->
                RutasListContent(
                    ...
                    favoriteFuncion = { ruta: Ruta, favorito: Boolean ->
                        viewModel.setRutaFavorita(
                            ruta,
                            favorito
                        )
                    },
            ...
            RutaScreenContent.Add ->
                RutasAddContent(
                    funAddRuta = { nombreRuta: String, inicio: LugarInteres, fin: LugarInteres, vehiculo: Vehiculo, tipoRuta: TipoRuta ->
