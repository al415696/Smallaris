...
class ServicioPrecioCombustible(private val valueForNotPresent: Double = -1.0) :
    ...
    override suspend fun getClosestCarburante(
        lugar: LugarInteres,
    ...
    private suspend fun obtenerPreciosCarburantes(lugar: LugarInteres): List<Combustible>? {
        ...
        if (mapIdMunicipio.containsKey(lugar.municipio)) {
            url =
                "https://sedeaplicaciones.minetur.gob.es/ServiciosRESTCarburantes/PreciosCarburantes/EstacionesTerrestres/FiltroMunicipio/" + mapIdMunicipio[lugar.municipio]
        } else {
    ...
    private fun getClosest(
        listCombustible: List<Combustible>,
        givenLocation: LugarInteres
    ): Combustible {
            ...
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    if (responseBody != null) {
                        ...
                        val gson = builder.create()
                        val data =
                            gson.fromJson(responseBody, Array<Municipio>::class.java).toList()
